...
pub fn cmd_resolve(beans_dir: &Path, id: &str, field: &str, choice: usize) -> Result<()> {
    let bean_path =
    ...
    bean.conflicts
        .retain(|c| c.resolution == ConflictResolution::Pending);
...
mod tests {
    use super::*;
    use crate::bean::{ConflictVersion, FieldConflict, Status};
    ...
    fn test_resolve_conflict_basic() {
        ...
        bean.conflicts = vec![FieldConflict {
    ...
    fn test_resolve_no_conflict_on_field() {
        ...
        assert!(result
            .unwrap_err()
            .to_string()
            .contains("No conflict for field"));
    }
